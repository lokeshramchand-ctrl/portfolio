    ...
    <footer className="border-t border-paper-500/10 bg-void-950">
      <div className="padding-x grid gap-12 py-16 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm text-paper-200">
            {siteConfig.locationCountry}
          </p>
          <p className="font-mono text-xs text-paper-100">
            {siteConfig.locationPlace}
          </p>
        </div>

        <div>
          <p className="text-xs tracking-widest text-paper-100 uppercase">
            Menu
          </p>
        ...
        <div>
          ...
          <p className="mt-4 font-mono text-sm text-paper-300">
            {localTime || "--:--"}{" "}
            <span className="text-paper-100">Lokesh</span>
          </p>
